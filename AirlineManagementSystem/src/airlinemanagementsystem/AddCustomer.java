...
public class AddCustomer extends JFrame implements ActionListener {
    JLabel lblname,lblnationality,lblaadhar,lbladdress,lblgender,lblnumber;
    JTextField tfname,tfnationality,tfaadhar,tfaddress,tfnumber;
    ...
    public AddCustomer(){
        ...
        btnsave.setBounds(220,380,80,30);
